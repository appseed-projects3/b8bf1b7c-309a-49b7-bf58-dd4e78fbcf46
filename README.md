...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-17 21:42`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b8bf1b7c-309a-49b7-bf58-dd4e78fbcf46.git
$ cd b8bf1b7c-309a-49b7-bf58-dd4e78fbcf46
```
